    ...
    <>
      ...
      <div className={` bg-white dark:bg-slate-900 h-full relative  `}>
        <div className="flex ">
          ...
          <div
            className={`  bg-white  dark:bg-gradient-to-r from-gray-800 via-slate-900 to-gray-800 rounded-xl w-[calc(100%-49px-49px)]  mx-auto mt-[63px] px-2 py-2 mb-1 border-[1.5px] dark:border-white  ${
