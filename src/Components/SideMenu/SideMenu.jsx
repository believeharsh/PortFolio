...
function SideMenu({ sidebar, RefSideMenu }) {
  return (
    <div
      ref={RefSideMenu}
      className={`h-full fixed z-[11] backdrop-blur-2xl bg-slate-900/30 dark:bg-slate-900/30 md:w-[226px] w-[270px] top-[53px] left-[44px] transform duration-[0.2s] ease-linear ${
      ...
      <div className="flex flex-col items-center justify-center space-y-3 md:mt-8 mt-[70px] p-1">
        ...
        <div className="flex flex-col justify-center item-center space-y-2">
          ...
          <div className="sidemenu-btn">
            ...
            <p className="md:text-sm xl:text-2xl sm:text-[10px]">Instagram</p>
          </div>
          <div className="sidemenu-btn">
            <a
