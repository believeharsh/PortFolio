...
function CommonProjectDiv(props) {
  ...
  <>
    <div className="flex  flex-wrap justify-center items-center">
                <div className="dark:bg-slate-900/60 bg-slate-900 shadow-sm dark:shadow-slate-100 rounded-2xl px-2 py-2 border-[1px] flex flex-col max-w-[280px]  mx-1 my-1 dark:hover:bg-slate-900/90">
